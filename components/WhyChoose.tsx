const reasons = [
  ...
  },
  {
    ...
    description:
      "From concept to finished product, we provide full OEM/ODM solutions — design, molding, painting and packaging to match your brand vision.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Established in 2005, our factory brings advanced equipment and skilled craftsmen to guarantee consistent quality and on-time delivery.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h2 className="text-2xl md:text-3xl font-bold text-stone-900 text-center mb-10">
          Why Choose Kelikuli Resin Toys &amp; Crafts
        </h2>
