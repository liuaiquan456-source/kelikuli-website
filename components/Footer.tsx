          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>[Factory Address, City, Province, China]</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/8613957959550" target="_blank" rel="noopener noreferrer" className="hover:text-[#B8935A] transition-colors">
                  WhatsApp: +86 139 5795 9550
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:860861@qq.com" className="hover:text-[#B8935A] transition-colors">860861@qq.com</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0 text-[#C9A55A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
                </svg>
                <span>WeChat: <span className="text-stone-300">kelikuli</span></span>
              </li>
            </ul>
            ...
            <div className="w-24 h-24 bg-white rounded-xl flex items-center justify-center">
              <div className="w-20 h-20 bg-stone-200 rounded-lg flex items-center justify-center">
                <svg className="w-10 h-10 text-stone-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M6.75 6.75h.75v.75h-.75v-.75zM6.75 16.5h.75v.75h-.75V16.5zM16.5 6.75h.75v.75h-.75v-.75zM13.5 13.5h.75v.75h-.75v-.75zM13.5 19.5h.75v.75h-.75v-.75zM19.5 13.5h.75v.75h-.75v-.75zM19.5 19.5h.75v.75h-.75v-.75zM16.5 16.5h.75v.75h-.75v-.75z" />
                </svg>
              </div>
            </div>
            <p className="text-xs mt-3 text-stone-500 leading-relaxed">
              Scan to contact us<br />on WeChat / WhatsApp
            </p>
          </div>
        </div>
      </div>
