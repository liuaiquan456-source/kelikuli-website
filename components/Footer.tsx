          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>No. 567 Anping Road, Zhengjiawu Town, Pujiang County, Jinhua City, Zhejiang Province, China</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/8613505893913" target="_blank" rel="noopener noreferrer" className="hover:text-[#B8935A] transition-colors">
