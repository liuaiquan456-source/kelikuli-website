        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3 mb-4 lg:hidden">
            <button
              ...
              className="flex items-center gap-2 bg-white border border-stone-200 rounded-xl px-4 py-2.5 text-sm text-stone-700 font-medium shadow-sm"
            >
        ...
        <div className="flex gap-6 items-start">
          ...
          <aside className="hidden lg:flex flex-col gap-4 w-56 shrink-0">
            ...
            <div className="bg-white rounded-2xl border border-stone-100 overflow-hidden">
              <div className="flex items-center justify-center gap-2 py-4 border-b border-stone-100">
                <span className="text-[#C9A55A] text-xs">✦</span>
                <span className="text-xs font-black uppercase tracking-widest text-stone-800">Categories</span>
                <span className="text-[#C9A55A] text-xs">✦</span>
              </div>
              <ul className="py-2">
                {categories.map((cat) => {
